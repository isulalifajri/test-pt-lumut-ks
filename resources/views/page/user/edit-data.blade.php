            ...
            <div class="card-body">
                <form action="{{ route('update', $data->id) }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" id="username" value="{{ old('username', $data->username) }}">
                        @error('username')
